...
set.seed(22020)
ver <- BiplotML::LogBip(dico[,-c(1)], method = "BFGS", random_start = TRUE)
ff <- plotBLB(ver, titles = "Biplot Logístico")
ff

ggsave(file = "G:/Mi unidad/GitRepos/talks/talks/Jaen/images/LogBip.png", 
       ff,
...
ggsave(file = "G:/Mi unidad/GitRepos/talks/talks/Jaen/images/LogBipSex.png", 
       g1,
       width = 9, height = 9, dpi = 100, units = "in", device='png')
...
ggsave(file = "G:/Mi unidad/GitRepos/talks/talks/Jaen/images/LogBipTedad.png", 
       g2,
       width = 9, height = 9, dpi = 100, units = "in", device='png')
...
ggsave(file = "G:/Mi unidad/GitRepos/talks/talks/Jaen/images/LogBipXDpto.png", 
       g3,
       width = 9, height = 9, dpi = 100, units = "in", device='png')
